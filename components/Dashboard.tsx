...
const Dashboard: React.FC<{ lang?: 'ar', onNavigate?: (view: any, params?: any) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F8FAFA] font-['Cairo'] overflow-hidden" dir="rtl">
      ...
      <div className="px-6 sm:px-10 py-12 bg-white border-b border-slate-100 flex flex-col items-center justify-center gap-8 shrink-0 z-20 shadow-sm relative overflow-hidden">
