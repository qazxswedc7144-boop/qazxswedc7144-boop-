...
import { getLiveMetrics } from '@/services/integrity/shared/liveDashboard';
import { accountingService } from '@/modules/accounting/services/accountingService';
import { analyticsEngine } from '@/modules/reports/services/analyticsEngine';
...
import { 
  ...
  ArrowUpRight, BarChart3, ShieldCheck, Lock, Info,
  Zap, Snail, Skull, Wallet2, DollarSign, ArrowDownCircle
} from 'lucide-react';
...
const FinancialDashboard: React.FC<{ onNavigate?: (view: any) => void }> = ({ onNavigate: _onNavigate }) => {
      ...
      <div className="bg-slate-900 text-white p-4 rounded-[28px] flex items-center justify-between shadow-xl">
         <div className="flex items-center gap-4">
            ...
            <div>
               ...
               <p className="text-[10px] opacity-60 font-bold uppercase tracking-widest">تحديث تلقائي عبر Dexie LiveQuery</p>
            </div>
         </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         <div className="lg:col-span-8 space-y-8">
            <Card className="h-96 !p-8">
               ...
               <div className="w-full h-64" style={{ minHeight: '300px' }}>
                  {isMounted && chartConfig && (
                    <Line 
                      data={chartConfig} 
                      options={{ 
                        responsive: true, 
