...
import { Tag, Wallet, Percent, Banknote, Scale } from 'lucide-react';
...
const AdjustmentForm: React.FC<AdjustmentFormProps> = ({ isOpen, onClose, invoiceId: _invoiceId, currency, onSave, initialType }) => {
