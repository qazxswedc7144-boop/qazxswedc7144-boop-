            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                 <li className="flex gap-3 text-slate-700">
                   ...
                   <span><strong>الوصول والحماية:</strong> تُساءل أنت شخصياً عن الحفاظ على أمان حسابك. نحن نستخدم مُعرّفات دخول آمنة لضمان أمان الدخول، ونوفر طبقة حماية متطورة للبيانات، ولكن يجب عليك حماية أجهزتك.</span>
                 </li>
                 <li className="flex gap-3 text-slate-700">
                   <CheckCircle2 size={24} className="text-emerald-500 flex-shrink-0" />
