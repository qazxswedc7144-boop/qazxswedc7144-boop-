...
import { accountingService, PartnerAging } from '@/modules/accounting/services/accountingService';
import { Card, Button } from '@/components/shared/SharedUI';
...
const AgingReportModule: React.FC<{ onNavigate?: (v: any) => void }> = ({ onNavigate: _onNavigate }) => {
