...
const validateTransaction = (_type: string, data: any) => {
...
const validateCash = async (amount: number) => {
  const cashAccounts = await safeWhereEqual<any>(db.db.accounts, "name", "Cash");
