...
class Database extends Dexie {
  ...
  async getInvoices() { return (await (this as any).invoices?.toArray()) || []; }
  ...
  constructor() {
    ...
    // Version 11: Consolidation and Fix for objectStore naming collisions
    this.version(11).stores({
      products: 'id, name, Name, barcode, user_id, updatedAt, deletedAt, isSynced, category, branchId',
      invoices: 'id, type, createdAt, isSynced, status, branchId',
      customers: 'id, name, isSynced',
      suppliers: 'id, name, isSynced',
      accounts: 'id, name, type, balance',
      sales: 'id, timestamp, SaleID, customerId, isSynced, date, InvoiceStatus',
      purchases: 'id, timestamp, purchase_id, partnerId, isSynced, date, invoiceStatus',
